...
class UpConvBlock(nn.Module):
    """
    A block consists of an upsampling layer followed by a convolutional layer to reduce the amount of channels and then
    a DownConvBlock. If bilinear is set to false, we do a transposed convolution instead of upsampling
    """
