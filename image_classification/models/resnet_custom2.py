...
def resnet18(pretrained=False, **kwargs):
    """Constructs a ResNet-18 model. Nota that if you change the number of classes
    and input channels the loading of the pre-trained model will no longer be possible here.
    In order to load those weights you need to do some manual surgery over the network, i.e.,
    removing the final fully connected layer and replacing it with your own with the desired
